...
public static class DownloaderDataFromGoogleSheets
{
    ...
    {
        UnityWebRequest curentResp = UnityWebRequest.Get($"https://sheets.googleapis.com/v4/spreadsheets/{sheetIndex}/values/Лист1?key=AIzaSyBC456hXyi8dgKhvbs8kut5Y94nhhtA6hw");
        await curentResp.SendWebRequest();
        return JSON.Parse(curentResp.downloadHandler.text);
    }
}
