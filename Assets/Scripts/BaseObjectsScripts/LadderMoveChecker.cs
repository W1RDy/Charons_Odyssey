...
public class LadderMoveChecker
{
    ...
    private bool IsCanMove(Player player, float direction, bool _isStartMoving)
    {
        ...
        float predictedPos; 
        if (_isStartMoving) predictedPos = playerCollider.bounds.center.y + normalizedDirection * playerCollider.bounds.size.y;
